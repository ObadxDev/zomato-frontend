...
const Restaurant = () => {
  ...
  let getRestaurantDetails = async () => {
    let url = `https://zomato-backend-xtmi.onrender.com/api/get-restaurant-details-by-id/${id}`;
  ...
  let getMenuList = async () => {
    let url = `https://zomato-backend-xtmi.onrender.com/api/get-menu-items-by-restaurant-id/${id}`;
  ...
  let makePayment = async () => {
    let url = `https://zomato-backend-xtmi.onrender.com/api/create-order-id`;
    ...
    var options = {
      ...
      handler: async function (response) {
        try {
          ...
          let url = `https://zomato-backend-xtmi.onrender.com/api/verify-payment`;
